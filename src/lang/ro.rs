...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua StaticDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca StaticDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala StaticDesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți StaticDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți StaticDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți StaticDesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [StaticDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep RustDesk background service", "Rulează serviciul StaticDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației StaticDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show RustDesk", "Afișează StaticDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi StaticDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi StaticDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din StaticDesk care rulează."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola StaticDesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi StaticDesk pentru a-ți accesa dispozitivul."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul StaticDesk pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu StaticDesk"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web StaticDesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări StaticDesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About RustDesk", "Despre StaticDesk"),
        ...
        ("web_id_input_tip", "Introdu ID-ul StaticDesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Versiunea clientului StaticDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
